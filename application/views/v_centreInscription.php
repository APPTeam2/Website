    ...
    <div id="form">
        ...
        <form method="post" action="<?php echo($url_base . 'Inscription/validationcreerPersonne') ?>" name="CreateUser">
            <fieldset id="infoForm">
                ...
                <input type="text" name="nom" id="nom" / required></input><br/>
                <label for="prenom">Prénom :</label>
                <input type="text" name="prenom" id="prenom" / required></input><br/>
            ...
            <fieldset id="infoForm">
                ...
                <input type="text" name="login" id="login" / required></input><br/>
                <label for="mdp">Mot de passe :</label>
                <input type="password" name="mdp" id="mdp" oncopy="return false;" oncut="return false;" / required></input><br/>
                <label for="mdp2">Retaper le mot de passe :</label>  <!-- vérification de mots de passe -->
                <input type="password" name="mdp2" id="mdp2" oncopy="return false;" oncut="return false;" / required></input><br/>
            </fieldset>
